...
<head>
  ...
  <title>Register YourSHOES</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="login"><img src="<?php echo base_url()?>gambar/logo.png" width=100px>Your<b>SHOES</b></a>
  </div>

  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Silahkan Isi Dahulu</p>
...
<!-- AdminLTE App -->
<script src="<?php echo base_url('asset/bootstrap/js/adminlte.min.js');?>"></script>
</body>
</html>